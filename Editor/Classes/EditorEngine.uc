...
defaultproperties
{
     ...
     GameCommandLine="-log"
     EditPackages=("Core","Engine","Editor","UWindow","Fire","IpDrv","UBrowser","WOTBrowser","IpServer","WinDrv","Legend","ParticleSystems","WOTBase","WOTTraps","WOT","Angreal","WOTPawns","WOTDecorations","MachinShin","Environment")
     C_WorldBox=(B=107)
     C_GroundPlane=(B=63)
