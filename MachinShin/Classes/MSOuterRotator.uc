...
//
//------------------------------------------------------------------------------
class MSOuterRotator expands MSRotator;

var() int NumFaces;
var() int NumFacesWithSound;
...
simulated function PreBeginPlay()
{
	...
	for( i = 0; i < NumFacesWithSound; i++ )
		Spawn( class'MSFaceWithSound', Self, Event, Location );
}

defaultproperties
{
     NumFaces=36
     NumFacesWithSound=36
     bUpdateActorRotation=False
     MinRadius=700.000000
