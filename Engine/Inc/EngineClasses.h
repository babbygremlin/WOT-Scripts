...
struct AActor_eventSeePlayer_Parms
{
    class AActor* Seen;
};
...
public:
    ...
    BYTE DetailLevel GCC_PACK(4);
    BYTE GoreLevel;
    BITFIELD bStasis:1 GCC_PACK(4);
    ...
    FVector Location;
    FRotator Rotation;
    BITFIELD bSpecialRotationRep:1 GCC_PACK(4);
    ...
    BITFIELD bMustFace:1 GCC_PACK(4);
    ...
    class UClass* DebugClass;
    class ADebug* DebugInterface;
    ...
    DECLARE_FUNCTION(execGetAnimFrames);
    ...
    DECLARE_FUNCTION(execGetGoreDetailLevel);
    DECLARE_FUNCTION(execGetMaxDetailLevel);
    ...
    {
        AActor_eventSeePlayer_Parms Parms;
        Parms.Seen=Seen;
...
public:
    ...
    void eventClientHearSound(class AActor* Actor, INT Id, class USound* S, BYTE Slot, FVector SoundLocation, FVector Parameters)
    {
    ...
    DECLARE_CLASS(APawn,AActor,0|CLASS_NativeReplication)
...
class ENGINE_API ADebug : public AActor
{
public:
    INT DBI_None;
    INT DBI_BehaviorDefault;
    INT DBI_BehaviorSet;
    INT DBI_BehaviorClear;
    INT DBI_BehaviorToggle;
    INT DB_None;
    INT DB_Enabled;
    INT DB_OutputLogFile;
    INT DB_OutputLogScreen;
    INT DB_CrashOnAssert;
    INT DB_PrefixObjectName;
    INT DB_PrefixObjectState;
    INT DB_PrefixDebugCategory;
    INT DB_PrefixTime;
    FName DC_None;
    FName DC_All;
    FName DC_Animation;
    FName DC_Sound;
    FName DC_StateTransition;
    FName DC_StateCode;
    FName DC_Notification;
    FName DC_EngineNotification;
    FName DC_BehaviorTransition;
    INT DebugBehaviors;
    FName DisclosedCategories[64];
    FTExecInterfaceInfo DebugExecInterface[32];
    DECLARE_FUNCTION(execSetDefaultDebugBehaviors);
    DECLARE_FUNCTION(execSetDebugBehaviors);
    DECLARE_FUNCTION(execGetDebugBehaviors);
    DECLARE_FUNCTION(execToggleDebugBehavior);
    DECLARE_FUNCTION(execClearDebugBehavior);
    DECLARE_FUNCTION(execSetDebugBehavior);
    DECLARE_FUNCTION(execDebugBehaviorInit);
    DECLARE_FUNCTION(execExecDebugBehaviorInit);
    DECLARE_FUNCTION(execSupressCategory);
    DECLARE_FUNCTION(execDiscloseCategory);
    DECLARE_FUNCTION(execDebugAssert);
    DECLARE_FUNCTION(execDebugWarn);
    DECLARE_FUNCTION(execDebugLog);
    DECLARE_CLASS(ADebug,AActor,0)
    NO_DEFAULT_CONSTRUCTOR(ADebug)
};
...
public:
    ...
    FLOAT RemainingTime GCC_PACK(4);
    FLOAT ElapsedTime;
    BITFIELD bDisplayRemaining:1 GCC_PACK(4);
    INT RemainingMinute GCC_PACK(4);
    FLOAT SecondCount;
...
public:
    ...
    BITFIELD bDisableAmbientSound:1 GCC_PACK(4);
    class ULevelSummary* Summary GCC_PACK(4);
    ...
    class AProjectile* ProjectileList;
    ...
    FStringNoInit MP3Filename GCC_PACK(4);
    BITFIELD bPathsRebuilt:1 GCC_PACK(4);
    DECLARE_FUNCTION(execGetAddressURL);
    DECLARE_FUNCTION(execGetLocalURL);
    DECLARE_FUNCTION(execRemoveProjectile);
    DECLARE_FUNCTION(execAddProjectile);
...
public:
    ...
    FLOAT ExploWallOut;
    BITFIELD bNotifySeePlayer:1 GCC_PACK(4);
    FLOAT SeePlayerRadius GCC_PACK(4);
    FLOAT SeePlayerHeight;
    class AProjectile* nextProjectile;
...
class ENGINE_API UActorCollection : public UObject
{
public:
    TArray<class AActor*> ItemList;
    INT Index;
    ...
    DECLARE_CLASS(UActorCollection,UObject,0)
    NO_DEFAULT_CONSTRUCTOR(UActorCollection)
};
...
AUTOGENERATE_FUNCTION(AActor,1061,execLineCheck);
...
AUTOGENERATE_FUNCTION(AActor,-1,execGetAnimFrames);
...
AUTOGENERATE_FUNCTION(AActor,-1,execGetGoreDetailLevel);
AUTOGENERATE_FUNCTION(AActor,-1,execGetMaxDetailLevel);
AUTOGENERATE_FUNCTION(ADebug,-1,execSetDefaultDebugBehaviors);
AUTOGENERATE_FUNCTION(ADebug,-1,execSetDebugBehaviors);
AUTOGENERATE_FUNCTION(ADebug,-1,execGetDebugBehaviors);
AUTOGENERATE_FUNCTION(ADebug,-1,execToggleDebugBehavior);
AUTOGENERATE_FUNCTION(ADebug,-1,execClearDebugBehavior);
AUTOGENERATE_FUNCTION(ADebug,-1,execSetDebugBehavior);
AUTOGENERATE_FUNCTION(ADebug,-1,execDebugBehaviorInit);
AUTOGENERATE_FUNCTION(ADebug,-1,execExecDebugBehaviorInit);
AUTOGENERATE_FUNCTION(ADebug,-1,execSupressCategory);
AUTOGENERATE_FUNCTION(ADebug,-1,execDiscloseCategory);
AUTOGENERATE_FUNCTION(ADebug,-1,execDebugAssert);
AUTOGENERATE_FUNCTION(ADebug,-1,execDebugWarn);
AUTOGENERATE_FUNCTION(ADebug,-1,execDebugLog);
...
AUTOGENERATE_FUNCTION(ALevelInfo,1071,execRemoveProjectile);
AUTOGENERATE_FUNCTION(ALevelInfo,1070,execAddProjectile);
AUTOGENERATE_FUNCTION(UActorCollection,1086,execIsDone);
AUTOGENERATE_FUNCTION(UActorCollection,1085,execGetCurrent);
AUTOGENERATE_FUNCTION(UActorCollection,1084,execGetNext);
AUTOGENERATE_FUNCTION(UActorCollection,1083,execGetFirst);
AUTOGENERATE_FUNCTION(UActorCollection,1082,execRemoveAll);
AUTOGENERATE_FUNCTION(UActorCollection,1081,execRemoveItem);
AUTOGENERATE_FUNCTION(UActorCollection,1080,execAddItem);
