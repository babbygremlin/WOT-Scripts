...
// Imports.
#exec Texture Import NAME=ConsoleBack File=Textures\Console.pcx //NEW
#exec Texture Import File=Textures\Border.pcx //NEW
...
var class<TimeDemo> TimeDemoClass;
...
event Tick( float Delta )
{
	...
	else if( bTimeDemo )
	{
		...
		TimeDemo = Viewport.Actor.Spawn(TimeDemoClass);
...
//#if 1 //NEW
	if ( !Viewport.Actor.bShowMenu && (Viewport.Actor.Level.Pauser != "") && (Viewport.Actor.Level.LevelAction == LEVACT_None) )
//#else
...
//#if 1 //NEW
					ShortMessages[I] = GetShortMessage( J );
//#else
