...
//#if 1 //NEW
// Override this function to add variables to be copied over to new copies.
// REQUIRED: Must call Super.InitializeCopy( Copy );
//
...
{
//#if 1 //NEW
	bCollideWorld = true; // added to fix Seal dropping problem
	bHeldItem = false; // added to fix Seal disappearing after 45s problem
//#endif
...
//#if 1 //NEW
// Added to fix disappearing artifacts inside chests.
	{
		bCollideWorld = false;
