...
//#if 1 //NEW
var() name ContentTag;	// Tag to use for contents spawned by this decoration.
//#endif
...
//#if 1 //NEW
	// stop sound on breakable decorations
	PlaySound( None, SLOT_Misc );
//#endif
...
//#if 1 //NEW
		dropped = Spawn(tempClass,,ContentTag);
//#else
