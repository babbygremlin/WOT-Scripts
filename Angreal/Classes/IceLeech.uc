...
{
     MeltTime=2.000000
     MeltingSound=Sound'Angreal.Ice.DeActivateIC'
     Exceptions(0)=(ClassType=Legion,Scale=12.000000)
     Exceptions(1)=(ClassType=BATrolloc,Scale=6.000000)
     Exceptions(2)=(ClassType=Trolloc,Scale=4.000000)
     Exceptions(3)=(ClassType=Minion,Scale=4.000000)
     GlowFog=(X=312.500000,Y=468.750000,Z=468.750000)
     GlowScale=-0.390000
     bDeleterious=True
     bDisplayIcon=True
     ...
     Texture=Texture'Angreal.Skins.JFrozen1'
