...
defaultproperties
{
    LightningTextures(0)=Texture'Effects.LSE_A01'
    LightningTextures(1)=Texture'Effects.LSE_A02'
    LightningTextures(2)=Texture'Effects.LSE_A03'
    LightningTextures(3)=Texture'Effects.LSE_A04'
    LightningTextures(4)=Texture'Effects.LSE_A05'
    LightningTextures(5)=Texture'Effects.LSE_A06'
    LightningTextures(6)=Texture'Effects.LSE_A07'
    LightningTextures(7)=Texture'Effects.LSE_A08'
    LightningTextures(8)=Texture'Effects.LSE_A09'
    LightningTextures(9)=Texture'Effects.LSE_A10'
    LightningTextures(10)=Texture'Effects.LSE_A11'
    LightningTextures(11)=Texture'Effects.LSE_A12'
    LightningTextures(12)=Texture'Effects.LSE_A13'
    LightningTextures(13)=Texture'Effects.LSE_A14'
    LightningTextures(14)=Texture'Effects.LSE_A15'
    LightningTextures(15)=Texture'Effects.LSE_A16'
    LightningTextures(16)=Texture'Effects.LSE_A17'
    LightningTextures(17)=Texture'Effects.LSE_A18'
    LightningTextures(18)=Texture'Effects.LSE_A19'
    LightningTextures(19)=Texture'Effects.LSE_A20'
    LightningTextures(20)=Texture'Effects.LSE_A21'
    LightningTextures(21)=Texture'Effects.LSE_A22'
    ...
    DrawType=2
    Style=3
    Texture=Texture'Effects.LSE_A01'
    Skin=Texture'Effects.LSE_A01'
    ScaleGlow=0.50
    AmbientGlow=200
    Fatness=157
    bUnlit=True
    MultiSkins(0)=Texture'Effects.LSE_A01'
    MultiSkins(1)=Texture'Effects.LSE_A01'
    MultiSkins(2)=Texture'Effects.LSE_A01'
    MultiSkins(3)=Texture'Effects.LSE_A01'
    MultiSkins(4)=Texture'Effects.LSE_A01'
    MultiSkins(5)=Texture'Effects.LSE_A01'
    MultiSkins(6)=Texture'Effects.LSE_A01'
    MultiSkins(7)=Texture'Effects.LSE_A01'
    LightType=1
    LightEffect=13
    LightBrightness=255
    LightHue=204
