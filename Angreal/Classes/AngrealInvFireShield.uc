...
{
     Duration=20.000000
     ReflectorClasses(0)=Class'Angreal.IgnoreFireElementReflector'
     ...
     StatusIconFrame=Texture'Angreal.Icons.M_ElShieldRed'
     InventoryGroup=64
     ...
     StatusIcon=Texture'Angreal.Icons.I_ElShieldRed'
     Style=STY_Masked
     Skin=Texture'Angreal.Skins.ElShieldRED'
