...
defaultproperties
{
     ...
     SkinAnim(0)=Texture'Angreal.Skins.Limpact_A01'
     SkinAnim(1)=Texture'Angreal.Skins.Limpact_A02'
     SkinAnim(2)=Texture'Angreal.Skins.Limpact_A03'
     SkinAnim(3)=Texture'Angreal.Skins.Limpact_A04'
     SkinAnim(4)=Texture'Angreal.Skins.Limpact_A05'
     SkinAnim(5)=Texture'Angreal.Skins.Limpact_A06'
     SkinAnim(6)=Texture'Angreal.Skins.Limpact_A07'
     SkinAnim(7)=Texture'Angreal.Skins.Limpact_A08'
     SkinAnim(8)=Texture'Angreal.Skins.Limpact_A09'
     SkinAnim(9)=Texture'Angreal.Skins.Limpact_A10'
     SkinAnim(10)=Texture'Angreal.Skins.Limpact_A11'
     SkinAnim(11)=Texture'Angreal.Skins.Limpact_A12'
     SkinAnim(12)=Texture'Angreal.Skins.Limpact_A13'
     SkinAnim(13)=Texture'Angreal.Skins.Limpact_A14'
     SkinAnim(14)=Texture'Angreal.Skins.Limpact_A15'
     SkinAnim(15)=Texture'Angreal.Skins.Limpact_A16'
     SkinAnim(16)=Texture'Angreal.Skins.Limpact_A17'
     SkinAnim(17)=Texture'Angreal.Skins.Limpact_A18'
     SkinAnim(18)=Texture'Angreal.Skins.Limpact_A19'
     RemoteRole=ROLE_None
     DrawType=DT_Mesh
     Style=STY_Translucent
     Skin=Texture'Angreal.Skins.Limpact_A01'
     Mesh=Mesh'Angreal.LSImpact'
     DrawScale=4.000000
     AmbientGlow=200
     bUnlit=True
     LightType=LT_Steady
