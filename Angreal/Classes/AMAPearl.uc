...
defaultproperties
{
    InitialScale=0.10
    FinalScale=20.00
    InitialScaleRate=40.00
    ScaleAccel=-20.00
    WaitTime=2.00
    Duration=8.00
    InitialAlpha=1.00
    FadeTime=0.50
    ColorVect=(X=150.00,Y=100.00,Z=200.00),
    AffectSound=Sound'AMAPearl.PawnWalksThruDome'
    UnAffectSound=Sound'AMAPearl.PawnWalksThruDome'
    AbsorbSound=Sound'AMAPearl.UnravelAM'
    ActivateSound=Sound'AMAPearl.ActivateAM'
    DeActivateSound=Sound'AMAPearl.DeActivateAM'
    FadingExpandRate=5.00
    EndLightRadius=25
    Priority=1
    ReflectorClasses(0)=Class'NoCastReflector'
    ReflectorClasses(1)=Class'NoBadEffectsReflector'
    UnAffectedTypes(0)=MashadarGuide
    UnAffectedTypes(1)=MachinShin
    bGenProjTouch=True
    ProjTouchTime=0.20
    ProjCollisionRadius=28.00
    ...
    Style=4
    bMustFace=False
    Skin=IceTexture'AMAPearl.AMApearl01'
    Mesh=Mesh'AMAPearl'
    bMeshCurvy=True
    bAlwaysRelevant=True
    SoundRadius=128
    AmbientSound=Sound'AMAPearl.AntiMagicAuraLoop4'
    bCollideWorld=False
    LightType=1
    LightEffect=14
    LightBrightness=255
