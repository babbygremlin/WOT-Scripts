...
defaultproperties
{
    ...
    DrawType=2
    Style=3
    Texture=Texture'Effects.RefWhite'
    Skin=Texture'Effects.RefWhite'
    ScaleGlow=0.50
    AmbientGlow=64
    Fatness=157
    bUnlit=True
    MultiSkins(0)=Texture'Effects.RefWhite'
    MultiSkins(1)=Texture'Effects.RefWhite'
    MultiSkins(2)=Texture'Effects.RefWhite'
    MultiSkins(3)=Texture'Effects.RefWhite'
    MultiSkins(4)=Texture'Effects.RefWhite'
    MultiSkins(5)=Texture'Effects.RefWhite'
    MultiSkins(6)=Texture'Effects.RefWhite'
    MultiSkins(7)=Texture'Effects.RefWhite'
    LightType=1
    LightEffect=13
    LightBrightness=255
    LightHue=204
