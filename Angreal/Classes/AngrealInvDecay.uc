...
defaultproperties
{
     ...
     MaxChargeUsedInterval=2.000000
     ...
     StatusIconFrame=Texture'Angreal.Icons.M_Decay'
     InventoryGroup=57
     PickupMessage="You got the Decay ter'angreal"
     PickupViewMesh=Mesh'Angreal.AngrealDecayPickup'
     StatusIcon=Texture'Angreal.Icons.I_Decay'
     Texture=None
     Mesh=Mesh'Angreal.AngrealDecayPickup'
     DrawScale=0.750000
}
