...
defaultproperties
{
     ...
     SPRadius=30.000000
     FollowFactor=1.000000
     FadeVolumeRate=0.500000
     RelativeOffset=(X=50.000000,Z=-30.000000)
     bNetTemporary=False
     Physics=PHYS_Rotating
     RemoteRole=ROLE_SimulatedProxy
     DrawType=DT_Sprite
     Style=STY_Translucent
     Texture=Texture'Angreal.BalefireHand.hand.BFHand_A01'
     DrawScale=0.500000
     AmbientGlow=200
     SoundRadius=72
     SoundVolume=255
     AmbientSound=Sound'Angreal.Balefire.LoopBF'
     LightType=LT_Steady
