...
defaultproperties
{
    ...
    MaxDamage=20.00
    MinDamage=10.00
    MomentumTransfer=20000.00
    Kickback=150.00
    EffectOffset=(X=0.00,Y=0.00,Z=20.00),
    ...
    LargestCollisionRadius=250.00
    bElementAir=True
    bCommon=True
    bOffensive=True
    bCombat=True
    RoundsPerMinute=120.00
    ...
    StatusIconFrame=Texture'Icons.M_AirBurst'
    InventoryGroup=51
    PickupMessage="You got the Air Pulse ter'angreal"
    PickupViewMesh=Mesh'AngrealAirBurst'
    PickupViewScale=0.30
    StatusIcon=Texture'Icons.I_AirBurst'
    Mesh=Mesh'AngrealAirBurst'
    DrawScale=0.30
}
