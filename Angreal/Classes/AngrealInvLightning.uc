...
defaultproperties
{
     AttachmentRange=180.000000
     MaxCollisionRadius=250.000000
     MaxEffectiveRange=900.000000
     MaxDamageRate=25.000000
     MaxWaterDamage=50.000000
     WaterDamageRadius=1000.000000
     PercentStrain=0.900000
     LatchDelay=0.300000
     ...
     StatusIconFrame=Texture'Angreal.Icons.M_LightningStrike'
     InventoryGroup=62
     PickupMessage="You got the Chain Lightning ter'angreal"
     PickupViewMesh=Mesh'Angreal.AngrealLightningStrikePickup'
     StatusIcon=Texture'Angreal.Icons.I_LightningStrike'
     Texture=None
     Mesh=Mesh'Angreal.AngrealLightningStrikePickup'
}
