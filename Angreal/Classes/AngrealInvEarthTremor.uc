...
defaultproperties
{
    ...
    StatusIconFrame=Texture'Icons.M_EarthTremor'
    InventoryGroup=60
    PickupMessage="You got the Earth Tremor ter'angreal"
    PickupViewMesh=Mesh'AngrealEarthTremorPickup'
    StatusIcon=Texture'Icons.I_EarthTremor'
    Mesh=Mesh'AngrealEarthTremorPickup'
}
