...
{
    Duration=15.00
    LeechClasses(0)=Class'DecreaseCommonChargesLeech'
    LeechClasses(1)=Class'DecreaseUncommonChargesLeech'
    LeechClasses(2)=Class'DecreaseRareChargesLeech'
    ...
    MinDripTime=1.00
    MaxDripTime=2.00
    PlayerDamageRate=0.20
    NPCDamageRate=0.10
    speed=75.00
    MaxSpeed=800.00
    SpawnSound=Sound'Decay.LaunchDC'
    ImpactSound=Sound'Decay.HitDC'
    bAnimLoop=True
    LifeSpan=0.00
    AnimRate=1.00
    DrawType=1
    Style=3
    Texture=Texture'Effects.DC_A01'
    DrawScale=0.80
    SoundRadius=160
    SoundVolume=255
    AmbientSound=Sound'Decay.LoopDC'
