...
{
     Duration=5.000000
     ReflectorClasses(0)=Class'Angreal.ReturnToSenderReflector'
     ...
     StatusIconFrame=Texture'Angreal.Icons.M_Reflect'
     PickupMessage="You got the Reflect ter'angreal"
     PickupViewMesh=Mesh'Angreal.AngrealReflectPickup'
     PickupViewScale=1.200000
     StatusIcon=Texture'Angreal.Icons.I_Reflect'
     Texture=None
     Mesh=Mesh'Angreal.AngrealReflectPickup'
     DrawScale=1.200000
}
