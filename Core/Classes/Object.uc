...
//#if 1 //NEW
native(1030) static final function rotator OrthoRotation( vector X, vector Y, vector Z );
native(1031) static final function rotator Normalize( rotator Rot );
//#else
...
native final function bool AttachDestroyObserver( Object Observer );
native final function DetachDestroyObserver( Object Observer );
native event SubjectDestroyed( Object Subject );
//#endif
...
//
native event Constructed();

//
// Called immediately after Delete(),
// but before ConditionalDestroy().
//
native event Destructed();
//#endif
