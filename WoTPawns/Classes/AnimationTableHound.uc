//=============================================================================
// AnimationTableHound.uc
// $Author: Mfox $
// $Date: 1/05/00 2:38p $
// $Revision: 5 $
//=============================================================================

class AnimationTableHound expands AnimationTableWOT abstract;
...
defaultproperties
{
     ...
     AnimList(6)=(AnimSlot=Death,AnimOdds=0.500000,AnimEndVector=(X=-8.000000),EAnimInfo=(AnimName=DEATHB,AnimRate=0.400000,AnimTweenToTime=0.200000))
     AnimList(7)=(AnimSlot=Death,AnimOdds=0.500000,AnimEndVector=(X=5.500000),EAnimInfo=(AnimName=DEATHF,AnimRate=0.400000,AnimTweenToTime=0.200000))
     ...
     AnimList(41)=(AnimSlot=DodgeRight,AnimOdds=1.000000,EAnimInfo=(AnimName=DodgeRightAnimRate))
