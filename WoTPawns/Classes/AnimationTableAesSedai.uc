//=============================================================================
// AnimationTableAesSedai.uc
// $Author: Mfox $
// $Date: 1/05/00 2:38p $
// $Revision: 3 $
//=============================================================================

class AnimationTableAesSedai expands AnimationTableWOT abstract;
...
defaultproperties
{
     ...
     AnimList(5)=(AnimSlot=Breath,AnimOdds=1.000000,EAnimInfo=(AnimName=Breath,AnimRate=0.200000,AnimTweenToTime=1.000000))
     AnimList(6)=(AnimSlot=Death,AnimOdds=1.000000,AnimEndVector=(X=7.500000),EAnimInfo=(AnimName=DEATHF,AnimRate=0.400000,AnimTweenToTime=0.200000))
     AnimList(7)=(AnimSlot=Death,AnimOdds=1.000000,AnimEndVector=(X=1.500000,Y=-1.000000),EAnimInfo=(AnimName=DEATHL,AnimRate=0.400000,AnimTweenToTime=0.200000))
     ...
     AnimList(16)=(AnimSlot=Run,AnimOdds=1.000000,EAnimInfo=(AnimName=Run,AnimRate=0.500000))
     AnimList(17)=(AnimSlot=RunL,AnimOdds=1.000000,EAnimInfo=(AnimName=RunL,AnimRate=0.500000))
     AnimList(18)=(AnimSlot=RunR,AnimOdds=1.000000,EAnimInfo=(AnimName=RunR,AnimRate=0.500000))
     AnimList(19)=(AnimSlot=Swim,AnimOdds=1.000000,EAnimInfo=(AnimName=Swim,AnimRate=0.340000))
     AnimList(20)=(AnimSlot=Wait,AnimOdds=0.900000,EAnimInfo=(AnimName=Breath,AnimRate=0.200000,AnimTweenToTime=0.200000))
     ...
     AnimList(30)=(AnimSlot=DodgeLeft,AnimOdds=1.000000,EAnimInfo=(AnimName=DodgeLeft,AnimRate=1.000000,AnimTweenToTime=0.100000))
     AnimList(31)=(AnimSlot=DodgeRight,AnimOdds=1.000000,EAnimInfo=(AnimName=DodgeRight,AnimRate=1.000000,AnimTweenToTime=0.100000))
