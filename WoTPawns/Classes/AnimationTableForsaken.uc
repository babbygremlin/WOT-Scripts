//=============================================================================
// AnimationTableForsaken.uc
// $Author: Mfox $
// $Date: 1/05/00 2:38p $
// $Revision: 5 $
//=============================================================================

class AnimationTableForsaken expands AnimationTableWOT abstract;
...
defaultproperties
{
     ...
     AnimList(6)=(AnimSlot=Death,AnimOdds=0.500000,AnimEndVector=(X=0.500000),EAnimInfo=(AnimName=DEATHB,AnimRate=0.400000,AnimTweenToTime=0.200000))
     AnimList(7)=(AnimSlot=Death,AnimOdds=0.500000,AnimEndVector=(X=0.500000),EAnimInfo=(AnimName=DEATHF,AnimRate=0.400000,AnimTweenToTime=0.200000))
     ...
     AnimList(40)=(AnimSlot=DodgeLeft,AnimOdds=1.000000,EAnimInfo=(AnimName=DodgeLeft,AnimRate=0.600000,AnimTweenToTime=0.100000))
     AnimList(41)=(AnimSlot=DodgeRight,AnimOdds=1.000000,EAnimInfo=(AnimName=DodgeRight,AnimRate=0.600000,AnimTweenToTime=0.100000))
