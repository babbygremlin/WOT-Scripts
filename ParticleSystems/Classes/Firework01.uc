...
// $Revision: 1 $
//
// Description:	Red/Yellow Proj Type
//------------------------------------------------------------------------------
// How to use this class:
//
//------------------------------------------------------------------------------
class Firework01 expands ParticleSprayer;
...
defaultproperties
{
     ...
     Particles(1)=Texture'ParticleSystems.Flares.PF14'
     Particles(2)=Texture'ParticleSystems.Appear.PinkCorona'
     Particles(3)=Texture'ParticleSystems.General.Prtcl14'
     Particles(4)=Texture'ParticleSystems.General.Prtcl05'
     Particles(5)=Texture'ParticleSystems.Sparks.Sparks12'
     bOn=True
     MinVolume=8.000000
     bInterpolate=True
     bStatic=False
